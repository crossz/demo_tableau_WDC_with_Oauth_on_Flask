(function() {
  ...
  const config = {
      apiUrl: '/api/v2/labP0Dashboard/qPCRRepeatCase'
  }; 
  ...
  $(document).ready(function() {
      ...
      $("#submitButton").click(function() {
          ...
          tableau.connectionName = "lab_qPCRRepeatCase"; // This will be the data source name in Tableau
