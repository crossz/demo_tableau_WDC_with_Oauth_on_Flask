(function() {
  ...
  const config = {
      apiUrl: '/api/v2/labP0Dashboard/positiveResult'
  }; 
  ...
  $(document).ready(function() {
      ...
      $("#submitButton").click(function() {
          ...
          tableau.connectionName = "lab_positiveResult"; // This will be the data source name in Tableau
              ...
              if (resp) {  
                ...
                for (const element of dataSource) {
                    tableData.push({
                        ...
                        "v01_report_sign_off_time": element["v01_report_sign_off_time"],
                        "is_v01_report_result_authorized": element["is_v01_report_result_authorized"],
                        "is_v02_report_result_authorized": element["is_v02_report_result_authorized"],
                        "v01_report_signoff_time": element["v01_report_signoff_time"],
                        "v01_end_process": element["v01_end_process"],
                        "v01_report_result": element["v01_report_result"],
                        "v02_end_process": element["v02_end_process"],
                        "v02_test_result": element["v02_test_result"]
                    });
                }
